fertilizer_dict = {
        'NHigh': """<b style = "color:#0c9a17;">The N value of soil is high and might give rise to weeds.</b>
        ...
        <p align="justify">5. <i>Use mulch (wet grass) while growing crops</i> - Mulch can also include sawdust and scrap soft woods </p><hr style = "height:2px; background-color:#0c9a17;">""",

        'Nlow': """<b style = "color:#0c9a17;">The N value of your soil is low.</b>
        <br/><br/> Please consider the following suggestions:
        ...
        <p align="justify">8. <i>Do nothing</i> – It may seem counter-intuitive, but if you already have plants that are producing lots of foliage, it may be best to let them continue to absorb all the nitrogen to amend the soil for your next crops.</p><hr style = "height:2px; background-color:#0c9a17;">""",

        'NNo': """<b style = "color:#0c9a17;">The N value of your soil is up to the mark</b>.<hr style = "height:2px; background-color:#0c9a17;">""",

        'PHigh': """<b style = "color:#0c9a17;">The P value of your soil is high.</b>
        <br/> <br/>Please consider the following suggestions:
        ...
        <p align="justify">5. Use crop rotations to decrease high phosphorous levels</p><hr style = "height:2px; background-color:#0c9a17;">""",

        'Plow': """<b style = "color:#0c9a17;">The P value of your soil is low.</b>
        <br/> <br/>Please consider the following suggestions:
        ...
        <p align="justify">9. If pH is high, addition of appreciable amount of organic matter will help acidify the soil. Application of acidifying fertilizers, such as ammonium sulfate, can help lower soil pH</p><hr style = "height:2px; background-color:#0c9a17;">""",

        'PNo': """<b style = "color:#0c9a17;">The P value of your soil is up to the mark.</b><hr style = "height:2px; background-color:#0c9a17;">""",

        'KHigh': """<b style = "color:#0c9a17;">The K value of your soil is high</b>.
        <br/> <br/>Please consider the following suggestions:
        ...
        <hr style = "height:2px; background-color:#0c9a17;">""",

        'Klow': """<b style = "color:#0c9a17;">The K value of your soil is low.</b>
        <br/><br/>Please consider the following suggestions:
        ...
        <p align="justify">5. Use Potash fertilizers since they contain high values potassium</p><hr style = "height:2px; background-color:#0c9a17;">
        """,

        'KNo': """<b style = "color:#0c9a17;">The K value of your soil is up to the mark.</b><hr style = "height:2px; background-color:#0c9a17;"s>"""
}